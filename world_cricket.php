...
<body>
	...
	<div class="navbar">
		<button class="book_tickets"><a href="book_tickets.html">Book Tickets</a></button>
			<a href="world_cricket2.html">Home</a>
			<div class="dropdown">
		...
		<p style="text-align: right; "><ul><strong>DID YOU KNOW?</strong></ul>
			...
			<li style="padding-top: 20px">GLENN MCGRATH HAS DISMISSED SACHIN TENDULKAR 13 TIMES IN INTERNATIONAL CRIKET</li></p>
